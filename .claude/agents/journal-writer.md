...
Create journal entries in `./journals/` using the naming pattern from the `## Naming` section injected by hooks.
...
3. Only create/edit journal files in `./journals/` — do not modify code files
