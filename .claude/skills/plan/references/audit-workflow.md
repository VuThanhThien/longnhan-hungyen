...
Load: `references/audit-personas.md`
...
Load: `references/audit-personas.md` for reviewer prompt template.
...
Record the modified suggestion. Set disposition to "Accept (modified)" in the Audit Review table.

### Step 8: Apply to Plan

For accepted findings, edit target phase files inline with marker.
Add `## Audit Review` section to `plan.md`.
