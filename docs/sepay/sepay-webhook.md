...
Tạo một giao dịch giả lập bằng cách đăng nhập vào tài khoản _Demo_, tại menu **Giao dịch → Giả lập giao dịch**. Chọn đúng Tài khoản ngân hàng tương ứng với webhooks bạn đã tạo
