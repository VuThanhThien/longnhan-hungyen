...
- **14 Specialist Agents** — Role-based AI personas for development tasks
...
├── PROJECT-STATUS.md        # Repo progress snapshot (sync with .claude/PROJECT-STATUS.md)
├── agent-memo.md            # Session handoff / next-step memo
├── agents/                  # 14 Specialist Agents (symlink → .claude/agents/)
├── skills/                  # 40 Skills (symlink → .claude/skills/)
