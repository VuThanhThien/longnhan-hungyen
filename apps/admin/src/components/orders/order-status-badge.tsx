...
const orderStatusConfig: Record<OrderStatus, { label: string; variant: 'default' | 'secondary' | 'destructive' | 'warning' | 'success' | 'info' | 'outline' }> = {
...
const paymentStatusConfig: Record<PaymentStatus, { label: string; variant: 'default' | 'secondary' | 'destructive' | 'warning' | 'success' | 'info' | 'outline' }> = {
