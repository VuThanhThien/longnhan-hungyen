...
export default function QrPaymentInfo({ totalAmount, orderCode }: QrPaymentInfoProps) {
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm">
      ...
      <ul className="space-y-1 text-blue-800">
        ...
        <li><span className="font-medium">Chủ tài khoản:</span> NGUYEN VAN A</li>
        {totalAmount != null && (
          <li><span className="font-medium">Số tiền:</span> {formatPrice(totalAmount)}</li>
        )}
        {orderCode && (
          <li>
      ...
      <p className="mt-3 text-xs text-blue-600">
        Vui lòng chuyển khoản trong vòng 24 giờ. Đơn hàng sẽ được xác nhận sau khi nhận thanh toán.
      </p>
    </div>
  );
}
